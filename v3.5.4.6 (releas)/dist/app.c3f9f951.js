...
function Notification(message) {
  //document.querySelector('.notification').style = "z-index: 2"
...
function Menu(Name, Surname) {
  ...
  document.querySelector('.offcanvas-title').innerHTML = "".concat(Name, " ").concat(Surname);
}
...
function authWithEmailAndPassword(email, password) {
  var apiKey = 'AIzaSyBTbdSfjlxDQtExcDU7_ApMEkhzlBKKnz4';
...
function GetName(token) {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/users.json?auth=".concat(token)).then(function (response) {
    return response.json();
  }).then(function (response) {
    if (response) {
      Object.keys(response).map(function (key) {
        if (response[key].login == login) {
          (0, _modal.Menu)(response[key].name, response[key].surname);
          ...
          if (response[key].admin) {
            ...
            document.querySelector('.dis-modal-del-body-left').hidden = false;
            document.querySelector('.dis-modal-del-body-right').hidden = false;
          } else {
            document.querySelector('#admin-panel').hidden = true;
          }

          (0, _modal.Notification)('Вход выполнен успешно!');
        }
      });
    }
  });
}
},{"./modal.js":"js/modal.js"}],"js/reg.js":[function(require,module,exports) {
"use strict";
...
function RegValid() {
  ...
  if (isValid) {
    form.addEventListener('submit', RegFormHandler, {
      once: true
    });
  }
}
...
function RegFormHandler(event) {
  event.preventDefault();
  name = document.querySelector('#name').value, surname = document.querySelector("#surname").value, login = document.querySelector('#regLogin').value, pass = document.querySelector('#regPass').value;
...
function Token(token) {
  if (token) {
    ...
    writeInDB();
    (0, _modal.Notification)('Вы успешно зарегистрировались!');
  } else {
...
},{"./modal.js":"js/modal.js"}],"js/upload.js":[function(require,module,exports) {
"use strict";
...
function upload(selector) {
  ...
  var open = element('button', ['open-btn'], 'Открыть');
  var upload = element('button', ['upload-btn', 'primary'], 'Загрузить');
  ...
  var removeHandler = function removeHandler(event) {
    ...
    var block = preview.querySelector("[data-name=\"".concat(name, "\"]")).closest('.preview-file');
  ...
  var uploadHandlers = function uploadHandlers() {
...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm2017.js"}],"js/disciplines.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addDisciplineInDB = addDisciplineInDB;
...
var dl = null,
    dm = null; //, leftBody = null, rightBody = null //

function getDisciplines() {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/disciplines.json").then(function (response) {
    return response.json();
  }).then(function (response) {
    dl = "";
    dm = "";
    Object.keys(response).map(function (key) {
      //document.querySelector('.disciplines-list').innerHTML 
      dl += "\n            <div class=\"dis-list\">\n                <div class=\"dis-remove\" data-name=\"".concat(key, "\">&times;</div> \n                <p>").concat(response[key].name, "</p>\n                <div class=\"dis-edit\" data-dis-name=\"").concat(response[key].name, "\" data-link=\"").concat(key, "\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModalEdtDis\">&seArr;</div> \n            </div>\n            "); //Лист выбора дисциплины при загрузке файлов

      document.querySelector('.list').innerHTML += "\n            <option value=\"".concat(key, "\">").concat(response[key].name, "</option>\n            "); //------------------------------------------------
    ...
    // document.querySelector('.bottom-div').classList.add('animate__fadeInDown')
  });
}
...
function addDiscipline(name, key) {
  //document.querySelector('.mainMenu-content').innerHTML 
  dm += "<div class=\"div-btn-mainMenu\"><button class=\"btn-mainMenu\" data-name=\"".concat(name, "\" data-dis-key=\"").concat(key, "\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModalDisInfo\">").concat(name, "</button></div>");
}

function addDisciplineInDB(name) {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/disciplines.json?auth=".concat(getToken()), {
    method: 'POST',
    body: JSON.stringify({
      name: name
    }),
    ...
    if (response.name) {
      reloadDisLists();
      (0, _modal.Notification)('Дисциплина успешно добавлена!');
    }
  });
}

var disList = document.querySelector('.disciplines-list');
...
function removeHandler(event) {
  ...
  if (event.target.dataset.name) {
    var name = event.target.dataset.name;
    var block = disList.querySelector("[data-name=\"".concat(name, "\"]")).closest('.dis-list');
  ...
  if (event.target.dataset.link) {
    ...
    document.querySelector('.edit-btn').innerHTML = "\n        <button class=\"btn\" data-bs-dismiss=\"modal\" id=\"".concat(link, "\">\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C</button>  \n        "); //Это фикс, он же костыль))

    document.querySelector("#".concat(link)).addEventListener('click', function () {
...
function removingDiscipline(name, block) {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/disciplines/".concat(name, ".json?auth=").concat(getToken()), {
    method: 'DELETE'
  }).then(function (response) {
    return response.json();
  }).then(function (response) {
    if (!response) {
      ...
      reloadDisLists();
      (0, _modal.Notification)('Дисциплина удалена!');
    } else {
      console.log(response);
      (0, _modal.Notification)('Ошибка при удалении!');
    }
  });
}
...
function changeDisName(name, disName) {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/disciplines/".concat(name, ".json?auth=").concat(getToken()), {
    ...
    if (response.name) {
      reloadDisLists();
      (0, _modal.Notification)('Название дисциплины изменено!');
    } else {
      console.log(response);
      (0, _modal.Notification)('Ошибка!');
    }
  });
}

var disMenu = document.querySelector('.mainMenu-content');
...
function disMenuHandler(event) {
  ...
  var disKey = event.target.dataset.disKey;
  var name = event.target.dataset.name; //document.querySelector('.dis-modal-body-left').innerHTML = ``
  //document.querySelector('.dis-modal-body-right').innerHTML = ``

  document.querySelector('.dis-modal').innerHTML = "".concat(name);
  var leftBody = "",
      rightBody = "",
      leftDel = "",
      rightDel = "";
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/disciplines/".concat(disKey, "/files.json")).then(function (response) {
    return response.json();
  }).then(function (response) {
    if (response) {
      Object.keys(response).map(function (key) {
        if (response[key].type == 'lit') {
          //document.querySelector('.dis-modal-body-left').innerHTML 
          leftBody += "\n                    <div class=\"dis-file\">\n                        <a href=\"".concat(response[key].url, "\" class=\"href\">").concat(response[key].name, "</a>\n                    </div>");
          leftDel += "<div class=\"remove-file\" data-dis-key=\"".concat(disKey, "\" data-file-key=\"").concat(key, "\">&times;</div>");
        }

        if (response[key].type == 'lab') {
          //document.querySelector('.dis-modal-body-right').innerHTML 
          rightBody += "\n                    <div class=\"dis-file\">\n                        <a href=\"".concat(response[key].url, "\" class=\"href\">").concat(response[key].name, "</a>\n                    </div>");
          rightDel += "<div class=\"remove-file\" data-dis-key=\"".concat(disKey, "\" data-file-key=\"").concat(key, "\">&times;</div>");
        }
      });
    }
    ...
    document.querySelector('.dis-modal-del-body-right').innerHTML = rightDel;
    document.querySelector('.dis-modal-del-body-left').innerHTML = leftDel;
  });
}

var disMenuFiles = document.querySelector('.dis-modal-body');
...
function removeFile(event) {
  ...
  var fileKey = event.target.dataset.fileKey;
  var disKey = event.target.dataset.disKey; //console.log(fileKey)

  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/disciplines/".concat(disKey, "/files/").concat(fileKey, ".json?auth=").concat(getToken()), {
    method: 'DELETE'
  }).then(function (response) {
    return response.json();
  }).then(function (response) {
    if (!response) {
      disMenuHandler(ev);
      (0, _modal.Notification)('Файл удалён!');
    } else {
      console.log(response);
      (0, _modal.Notification)('Ошибка при удалении!');
    }
...
},{"./modal.js":"js/modal.js"}],"js/uploadInFirebase.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadInFirebase = uploadInFirebase;
...
var _disciplines = require("./disciplines.js");
...
function uploadInFirebase(file, blocks, index) {
  var select = document.querySelector('.list');
  var option = select.querySelector("option[value=\"".concat(select.value, "\"]"));
  var type = document.querySelector('.type-list').querySelector("option[value=\"".concat(document.querySelector('.type-list').value, "\"]")).value;
  var storageRef = (0, _storage.ref)(storage, "".concat(option.textContent, "/").concat(type, "/").concat(file.name));
  ...
  uploadTask.on('state_changed', function (snapshot) {
    ...
    (0, _storage.getDownloadURL)(storageRef).then(function (url) {
      return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/disciplines/".concat(option.value, "/files.json?auth=").concat((0, _disciplines.getToken)()), {
        method: 'POST',
        body: JSON.stringify({
          type: type,
          name: file.name,
        ...
        if (response) {
          (0, _modal.Notification)('Загрузка прошла успешно!'); //document.querySelector('.primary').disabled = true //Или блокировать нажатие?
          //document.querySelector('.preview').innerHTML = `` //Очистка загруженных файлов?????????
        } else {
          (0, _modal.Notification)('Неизвестная ошибка!');
        }
      });
    });
  });
...
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js","./modal.js":"js/modal.js","./disciplines.js":"js/disciplines.js"}],"js/tests.js":[function(require,module,exports) {
"use strict";
...
function createQuestionList() {
  ...
  if (num) {
    ...
    for (var i = 1; i <= num; i++) {
      document.querySelector('.create-test-footer').innerHTML += "\n            <div>\n                <p>\u0412\u043E\u043F\u0440\u043E\u0441 \u2116".concat(i, "</p>\n                <input type=\"text\" id=\"quest").concat(i, "\" class=\"form-control\">\n                <p>\u041E\u0442\u0432\u0435\u0442</p>\n                <input type=\"text\" id=\"answer").concat(i, "\" class=\"form-control\">\n            </div>");
    }
...
function collectTest() {
  var testp = document.querySelector('.create-test-footer'); //console.log(testp.querySelector('#testName').value)

  var codeParse = "";
  var answers = "";

  for (var i = 1; i <= num; i++) {
    codeParse += "\n        <div>\n            <p>\u0412\u043E\u043F\u0440\u043E\u0441 \u2116".concat(i, "</p>\n            <p>").concat(testp.querySelector("#quest".concat(i)).value, "</p>\n            <p>\u041E\u0442\u0432\u0435\u0442</p>\n            <input type=\"text\" class=\"form-control my-answer").concat(i, "\">\n        </div>");
    answers += "\n            <p class=\"answer".concat(i, "\">").concat(testp.querySelector("#answer".concat(i)).value, "</p>\n        "); //<p hidden="true">Ответ: ${testp.querySelector(`#answer${i}`).value}</p>
    //console.log(`Вопрос №${i}`)
    //console.log(testp.querySelector(`#quest${i}`).value)
  }

  addTestInDB(testp.querySelector('#testName').value, codeParse, answers); //clear()
}

function addTestInDB(name, codeParse, answers) {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/tests.json?auth=".concat((0, _disciplines.getToken)()), {
    method: 'POST',
    body: JSON.stringify({
      name: name,
      codeParse: codeParse,
    ...
    if (response.name) {
      (0, _modal.Notification)('Тест успешно добавлен!');
      clear();
    }
...
var testList = document.querySelector('.modal-test-list');
var testListSettings = document.querySelector('.test-list-settings');

function getTestList() {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/tests.json?auth=".concat((0, _disciplines.getToken)())).then(function (response) {
    return response.json();
  }).then(function (response) {
    //document.querySelector('.modal-test-list')
    testList.innerHTML = "";
    testListSettings.innerHTML = ""; //console.log(event.target.className)

    Object.keys(response).map(function (key) {
      //document.querySelector('.modal-test-list')
      //setTimeout(() => {}, 300)
      if (response[key].access == 'open') {
        testList.innerHTML += "<div class=\"animate__animated animate__fadeInUp\">\n                    <button type=\"button\" id=\"test-qw\" data-name=\"".concat(response[key].name, "\" data-link=\"").concat(key, "\" class=\"btn-test\" data-bs-dismiss=\"modal\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModalPassingTest\">\n                        ").concat(response[key].name, "\n                    </button>\n                </div>"); //testListDel.innerHTML += `<div><button data-link-del="${key}">&times;</button></div>`
      }
    }); //document.querySelector(`#test-qw`).addEventListener('click', addTest)
  });
}
...
function settingsTestList() {
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/tests.json?auth=".concat((0, _disciplines.getToken)())).then(function (response) {
    ...
    //document.querySelector('.modal-test-list')
    testList.innerHTML = "";
    testListSettings.innerHTML = "<div class=\"meaning-btn\"></div><div class=\"del-btn\"></div>"; //console.log(event.target.className)

    Object.keys(response).map(function (key) {
      testList.innerHTML += "<div>\n            <button type=\"button\" id=\"test-qw\" data-name=\"".concat(response[key].name, "\" data-link=\"").concat(key, "\" class=\"btn-test\" data-bs-dismiss=\"modal\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModalPassingTest\">\n                ").concat(response[key].name, "\n            </button>\n        </div>");
      testListSettings.querySelector('.del-btn').innerHTML += "<div><button class=\"btn-test\" data-link-del=\"".concat(key, "\">&times;</button></div>");

      if (response[key].access == 'closed') {
        testListSettings.querySelector('.meaning-btn').innerHTML += "<div><button data-link=\"".concat(key, "\" class=\"btn-test test-open\" data-meaning=\"open\">\u041E\u0442\u043A\u0440\u044B\u0442\u044C</button></div>");
      }

      if (response[key].access == 'open') {
        testListSettings.querySelector('.meaning-btn').innerHTML += "<div><button data-link=\"".concat(key, "\" class=\"btn-test test-closed\" data-meaning=\"closed\">\u0417\u0430\u043A\u0440\u044B\u0442\u044C</button></div>");
      }
    }); //document.querySelector(`#test-qw`).addEventListener('click', addTest)
  });
}
...
function addTest(event) {
  if (event.target.dataset.name && event.target.dataset.link) {
    ...
    return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/tests/".concat(link, ".json?auth=").concat((0, _disciplines.getToken)())).then(function (response) {
      return response.json();
    }).then(function (response) {
      document.querySelector('.test-body').innerHTML = "".concat(response.codeParse);
      document.querySelector('.test-footer').hidden = false;
      testAnswers = "".concat(response.answers);
      num = response.num;
    });
  }
}
...
function testVerify() {
  ...
  for (var i = 1; i <= num; i++) {
    myAnswer = document.querySelector('.test-body').querySelector(".my-answer".concat(i)).value;
    answer = document.querySelector('.test-answers').querySelector(".answer".concat(i)).innerHTML;
  ...
  document.querySelector('.test-body').innerHTML = "<h3>\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442: ".concat(res + '/' + num, "</h3>");
...
function deleteTest(event) {
  if (event.target.dataset.linkDel) {
    var linkDel = event.target.dataset.linkDel;
    return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/tests/".concat(linkDel, ".json?auth=").concat((0, _disciplines.getToken)()), {
      method: 'DELETE'
    }).then(function (response) {
      return response.json();
    }).then(function (response) {
      if (!response) {
        settingsTestList();
        (0, _modal.Notification)('Успешно удален!');
      } else {
        (0, _modal.Notification)('Неизвестная ошибка');
  ...
  if (event.target.dataset.link && event.target.dataset.meaning) {
    var link = event.target.dataset.link;
    var meaning = event.target.dataset.meaning; //console.log(meaning)

    return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/tests/".concat(link, ".json?auth=").concat((0, _disciplines.getToken)()), {
      method: 'PATCH',
      body: JSON.stringify({
        access: meaning
      }),
      ...
      if (response) {
        settingsTestList(); //console.log(response)

        (0, _modal.Notification)('Состояние теста изменено!');
      } else {
        (0, _modal.Notification)('Неизвестная ошибка');
        console.log(response.error);
      }
...
function clear() {
  //const testp = document.querySelector('.create-test-footer').innerHTML
  //test(testp)
  document.querySelector('.test-modal-footer').hidden = true;
  document.querySelector('.create-test-footer').innerHTML = "";
  document.querySelector('.create-test-body').hidden = false;
}
},{"./modal.js":"js/modal.js","./disciplines.js":"js/disciplines.js"}],"js/report.js":[function(require,module,exports) {
"use strict";
...
function report() {
  var report = document.querySelector('#report-label').value;
  var contactInfo = document.querySelector('#contact-info-label').value;

  if (!report || !contactInfo) {
    return (0, _modal.Notification)('Заполните все поля!');
  }
  ...
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/reports.json", {
    ...
    if (!response.error) {
      ...
      (0, _modal.Notification)('Репорт успешно отправлен!');
    } else {
      (0, _modal.Notification)('Ошибка!');
    }
  });
}
},{"./modal.js":"js/modal.js"}],"js/account.js":[function(require,module,exports) {
"use strict";
...
function editProfile() {
  ...
  uSurname = document.querySelector('#uSurname').value;
  return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/users/".concat(sessionStorage.getItem('RP_HCRAM_03'), ".json"), {
    //?auth=${123}`, {
    method: 'PATCH',
    body: JSON.stringify({
      name: uName,
    ...
    if (response) {
      ...
      document.querySelector('.offcanvas-title').innerHTML = "".concat(response.name, " ").concat(response.surname);
      (0, _modal.Notification)('Ваши данные изменены!');
    } else {
      console.log(response);
      (0, _modal.Notification)('Ошибка!');
    }
...
},{"./modal.js":"js/modal.js"}],"js/app.js":[function(require,module,exports) {
"use strict";

var _auth = require("./auth.js");

var _reg = require("./reg.js");

var _modal = require("./modal.js");

var _upload = require("./upload.js");

var _uploadInFirebase = require("./uploadInFirebase.js");
...
(0, _upload.upload)('#file', {
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      (0, _uploadInFirebase.uploadInFirebase)(file, blocks, index);
    });
  }
...
document.querySelector('#addDiscipline').addEventListener('click', function () {
  if (document.querySelector('#dispName').value) {
    (0, _disciplines.addDisciplineInDB)(document.querySelector('#dispName').value);
...
document.querySelector('#btnReg').addEventListener('click', _reg.RegValid);
document.querySelector('#bthAut').addEventListener('click', _auth.AutValid);
document.addEventListener('DOMContentLoaded', Load); //Ввод в лейбл только цифр

$(".inp-questions-number").keypress(function (event) {
  event = event || window.event;
  if (event.charCode && event.charCode != 0 && (event.charCode < 48 || event.charCode > 57)) return false;
}); //Read disciplines in DB

(0, _disciplines.getDisciplines)(); // Functions ------------------------------------------------------------------------
// Load page

function Load() {
  document.querySelector('#admin-panel').hidden = true;
  document.querySelector('.test-list-settings').hidden = true;
  document.querySelector('.dis-modal-del-body-left').hidden = true;
  document.querySelector('.dis-modal-del-body-right').hidden = true;

  if (sessionStorage.getItem('UserName') && sessionStorage.getItem('UserSurname')) {
    return fetch("https://edupor-web-app-default-rtdb.europe-west1.firebasedatabase.app/users.json?auth=".concat(sessionStorage.getItem('RP_XB1ON_11'))).then(function (response) {
      return response.json();
    }).then(function (response) {
      var flag = false;
      Object.keys(response).some(function (key) {
        if (response[key].name == sessionStorage.getItem('UserName') && response[key].surname == sessionStorage.getItem('UserSurname')) {
          (0, _modal.Menu)(sessionStorage.getItem('UserName'), sessionStorage.getItem('UserSurname'));
          sessionStorage.setItem('RP_HCRAM_03', key);
...
runOnKeys(function () {
  return alert("Поздравляю, ты нашёл главную посхалку! Отпиши мне плз, чтобы я знал, что её разгадали (inst: @__gleb4ik)");
}, "KeyA", "KeyD", "KeyM");
},{"./auth.js":"js/auth.js","./reg.js":"js/reg.js","./modal.js":"js/modal.js","./upload.js":"js/upload.js","./uploadInFirebase.js":"js/uploadInFirebase.js","./disciplines.js":"js/disciplines.js","./tests.js":"js/tests.js","./report.js":"js/report.js","./account.js":"js/account.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
